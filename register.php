...
// 1. กำหนด Webhook URL ของ n8n
// เปลี่ยนจาก 'http://127.0.0.1:5678/...'
// เป็นชื่อ Container (Service Name) คือ 'n8n'
$n8n_webhook_url = 'http://n8n:5678/webhook/smart-insight/register';

// ... โค้ด PHP ส่วนที่เหลือยังคงเดิม
